...
! -----------------------------------------------------------------------------------
    ...
    SUBROUTINE ReadControlParameterFileSub(CntrPar, zmqVar, accINFILE, accINFILE_size, RootName, ErrVar)!, accINFILE_size)
        ...
        CALL ParseInput(FileLines,'DAC_Mode',        CntrPar%Flp_Mode,          accINFILE(1), ErrVar, UnEc=UnEc)
        ...
        !------------ Flaps ------------
        CALL ParseInput(FileLines, 'dac_param',         CntrPar%dac_param,          accINFILE(1), ErrVar,   CntrPar%Flp_Mode == 0, UnEc)
        CALL ParseInput(FileLines, 'DAC_Kp',            CntrPar%DAC_Kp,             accINFILE(1), ErrVar,   CntrPar%Flp_Mode == 0, UnEc)
        CALL ParseInput(FileLines, 'DAC_Ki',            CntrPar%DAC_Ki,             accINFILE(1), ErrVar,   CntrPar%Flp_Mode == 0, UnEc)
        CALL ParseInput(FileLines, 'DAC_Model',         CntrPar%DAC_Model,          accINFILE(1), ErrVar,   CntrPar%Flp_Mode == 0, UnEc)
        CALL ParseInput(FileLines, 'dac_maxval',        CntrPar%dac_maxval,         accINFILE(1), ErrVar,   CntrPar%Flp_Mode == 0, UnEc)
        CALL ParseInput(FileLines, 'dac_bb_threshold',  CntrPar%dac_bb_threshold,   accINFILE(1), ErrVar,   CntrPar%Flp_Mode == 0, UnEc)
        CALL ParseInput(FileLines, 'dac_bb_startDelay', CntrPar%dac_bb_startDelay,  accINFILE(1), ErrVar,   CntrPar%Flp_Mode == 0, UnEc)
        CALL ParseInput(FileLines, 'dac_bb_depTime',    CntrPar%dac_bb_depTime,     accINFILE(1), ErrVar,   CntrPar%Flp_Mode == 0, UnEc)
        CALL ParseInput(FileLines, 'dac_bb_useIDAC',    CntrPar%dac_bb_useIDAC,     accINFILE(1), ErrVar,   CntrPar%Flp_Mode == 0, UnEc)
        IF (ErrVar%aviFAIL < 0) RETURN
